...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"Sin resultado",sInfo:"Mostrando _START_ de _END_ de _TOTAL_ resultados",sInfoEmpty:"Mostrando 0 de 0 de 0 resultados",
sInfoFiltered:"(filtrado de un total de _MAX_)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar de a _MENU_ resultados",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Buscar...",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se encontraron coincidencias"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
